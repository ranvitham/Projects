...
def main():
    ...
    tk.Button(control_frame, text="Turn Left 45",command=send_left_45).grid(row=3, column=1)
    tk.Button(control_frame, text="Turn Left 70",command=send_left_70).grid(row=3, column=2)
    ...
    tk.Button(control_frame, text="Turn Right 45",command=send_right_45).grid(row=4, column=1)
    tk.Button(control_frame, text="Turn Right 70",command=send_right_70).grid(row=4, column=2)
    ...
    tk.Button(control_frame, text="Done", command=send_done).grid(row=5, column=1, columnspan=2)
    tk.Button(control_frame, text= "180", command=send_180).grid(row= 2, column = 3)
    #Input Boxes
...
def socket_thread():
    ...
    while gui_send_message != "quit\n":
        ...
        if gui_send_message in forward:
            cybot.write(gui_send_message.encode())
            time.sleep(1)
            print(gui_send_message)
            msg = 'Nothing found'
